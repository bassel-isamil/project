...
import 'package:project/Create_account.dart';
import 'package:project/Custom_email_field.dart';
import 'package:project/Custom_password_field.dart';
      ...
      child: Column(
        children: [
          ...
          Expanded(
              child: Column(
            children: [
              Custom_email_field("E-mail",email=TextEditingController()),
              Custom_password_field("password",password=TextEditingController()),
              SizedBox(height: 20),
              Column(
                children: [
                  Row(
