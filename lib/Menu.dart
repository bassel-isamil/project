      ...
      body: Column(
        ...
        children: [
              ...
              children: [
                CircleAvatar(
                  child: Image.network(
                      ...
                      "+MbT03dnEr6AAAAAElFTkSuQmCC",height: 500,width: 500,),
                ),
              ],
            ),
          ),
          Padding(
            ...
            child: Row(
              children: [
TextButton(onPressed: (){}, child: Text("privacy",style: TextStyle(color: Colors.black)))              ],
            ),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Row(
              children: [TextButton(onPressed: (){}, child: Text("settings",style: TextStyle(color: Colors.black),))
              ],
            ),
          ),
          Padding(
